...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Research Assistant',
    description: 'Replay this Agent conversation on Research Assistant',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Research Assistant';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Research Assistant';
