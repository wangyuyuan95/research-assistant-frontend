...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const signOut = async () => {
    // Clear knowledge base selection on logout
    try {
      localStorage.removeItem('selected-knowledge-bases');
    } catch (error) {
      console.warn('Failed to clear knowledge base selection on logout:', error);
    }
