...
import { Loader2, Filter, ChevronLeft, ChevronRight, FolderOpen, Mail, Calendar, Globe, Lock, Check } from 'lucide-react';
import { useProjectsApi } from '@/hooks/use-statistics-api';
...
export function ProjectsList() {
  ...
  }, [page, pageSize, userEmails, excludeUserEmails, fetchProjects]);
  ...
  const handleSearch = () => {
    ...
    console.log('Projects handleSearch - Raw inputs:', { startTime, endTime });
    console.log('Projects handleSearch - Formatted:', { startTimeFormatted, endTimeFormatted });
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="text-center text-destructive">
            {t('statistics.errorLoadingProjects')}
          </div>
        </CardContent>
      </Card>
    );
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            {t('statistics.projectsList')} ({totalCount.toLocaleString()})
          </CardTitle>
        </CardHeader>
        <CardContent>
          {isLoading ? (
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>{t('statistics.projectName')}</TableHead>
                      <TableHead>{t('statistics.owner')}</TableHead>
