        ...
        <div className="flex h-14 items-center gap-4 px-4">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className="h-8 w-8"
              aria-label={t('tooltips.viewFiles')}
            >
            ...
            <Button
              ...
              className="h-8 w-8"
              aria-label={isPlaying ? t('tooltips.pauseReplay') : t('tooltips.playReplay')}
            >
              {isPlaying ? (
            ...
            <Button
              ...
              className="h-8 w-8"
              aria-label={t('tooltips.restartReplay')}
            >
            ...
            <Button
              ...
              aria-label={t('tooltips.toggleToolPanel')}
            >
