                ...
                <div className={cn("flex flex-wrap gap-3", className)} style={{ maxHeight }}>
                    ...
                    {moreCount > 0 && (
                        <button
                            ...
                            title={t('attachments.moreFiles', { count: moreCount })}
                        >
                            <div className="flex items-center gap-2">
                                <div className="flex items-center justify-center w-6 h-6 bg-primary/10 rounded-full">
                                    <Plus size={14} className="text-primary" />
                                </div>
                                <span className="text-sm font-medium">{t('attachments.moreCount', { count: moreCount })}</span>
                            </div>
                        </button>
                    )}
                </div>
            ...
            <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
                    <DialogHeader className="mb-1">
                        <DialogTitle>
                            <span>{t('attachments.allFiles', { count: uniqueFiles.length })}</span>
                        </DialogTitle>
                    </DialogHeader>
