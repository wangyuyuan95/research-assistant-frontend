...
export interface WebSearchResult {
  ...
  // 知识库专用字段
  source?: 'web_search' | 'knowledge_base';
  highlight?: string;
  ...
  if ('tool_execution' in parsedContent && typeof parsedContent.tool_execution === 'object') {
    ...
    const extractedData = {
      ...
      results: parsedOutput?.results?.map((result: any) => ({
        ...
        highlight: result.highlight || undefined,
        important_keywords: result.important_keywords || undefined,
        dataset_name: result.dataset_name || undefined,
