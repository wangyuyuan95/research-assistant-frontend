...
export function BrowserToolView({
  ...
  const vncIframe = useMemo(() => {
    ...
    return (
      <iframe
        src={vncPreviewUrl}
        title={t('toolViews.browser.browserPreview')}
  ...
  return (
    <Card className="gap-0 flex border shadow-none p-0 rounded-none flex-col h-full overflow-hidden">
        ...
        <div className="flex flex-row items-center justify-between">
          ...
          {!isRunning && (
            ...
            >
              ...
              {isSuccess ? t('toolViews.browser.browserActionCompleted') : t('toolViews.browser.browserActionFailed')}
            </Badge>
          )}
          ...
          {isRunning && (
            <Badge className="bg-gradient-to-b from-blue-200 to-blue-100 text-blue-700 dark:from-blue-800/50 dark:to-blue-900/60 dark:text-blue-300">
              ...
              {t('toolViews.browser.executingBrowserAction')}
            </Badge>
          )}
        </div>
      </CardHeader>
        ...
        <div className="flex-1 flex h-full items-stretch bg-white dark:bg-black">
            ...
            isRunning && vncIframe ? (
                ...
                <div className="relative w-full h-full min-h-[600px]" style={{ minHeight: '600px' }}>
                  ...
                  <div className="absolute top-4 right-4 z-10">
                    <Badge className="bg-blue-500/90 text-white border-none shadow-lg animate-pulse">
                      ...
                      {operation} {t('toolViews.browser.inProgress')}
                    </Badge>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 flex flex-col items-center justify-center w-full bg-gradient-to-b from-white to-zinc-50 dark:from-zinc-950 dark:to-zinc-900 text-zinc-700 dark:text-zinc-400">
                ...
                <h3 className="text-xl font-semibold mb-2 text-zinc-900 dark:text-zinc-100">
                  {t('toolViews.browser.browserPreviewNotAvailable')}
                </h3>
                {url && (
                  <div className="mt-4">
                    <Button 
          ...
          (screenshotUrl || screenshotBase64) ? (
            ...
            <div className="p-8 h-full flex flex-col items-center justify-center w-full bg-gradient-to-b from-white to-zinc-50 dark:from-zinc-950 dark:to-zinc-900 text-zinc-700 dark:text-zinc-400">
              ...
              <h3 className="text-xl font-semibold mb-2 text-zinc-900 dark:text-zinc-100">
                {t('toolViews.browser.noBrowserStateAvailable')}
              </h3>
              <p className="text-sm text-zinc-500 dark:text-zinc-400">
                {t('toolViews.browser.browserStateImageNotFoundForThisAction')}
              </p>
            </div>
          )}
        </div>
      ...
      <div className="px-4 py-2 h-10 bg-gradient-to-r from-[#F2F5FF]/90 to-[#F2F5FF]/90 dark:from-zinc-900/90 dark:to-zinc-800/90 backdrop-blur-sm border-t border-zinc-200 dark:border-zinc-800 flex justify-between items-center gap-4">
